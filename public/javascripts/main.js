...
$(function () {
    ...
    'use strict';
    var apiBaseUrl = "https://private-055e1-twistrating.apiary-mock.com";
    var publicBaseUrl = "https://private-055e1-twistrating.apiary-mock.com";
    ...
    function buildChart($twist, $twistStats) {
        ...
        $.getJSON(apiBaseUrl+"/twist/" + id, function (twistData) {
            var data = {
                    labels: ["Nam", "Hm", "Æsj"],
                    datasets: [{
                            label: "",
    ...
    //startLiveUpdate(); //This will not be necessary when using firebase.
